...
const CHANNELS = [
  ...
  { id:'toi',      name:'Times of Israel',color:'#2563EB',icon:'🌍', url:'https://www.timesofisrael.com/feed/',                                       limit:4 },
  { id:'walla_news',name:'וואלה חדשות', color:'#1a56db', icon:'📻', url:'https://rss.walla.co.il/feed/1',                                             limit:4 },
  ...
  { id:'jpost',    name:'Jerusalem Post', color:'#003399', icon:'🌍', url:'https://www.jpost.com/Rss/RssFeedsHeadlines.aspx',                           limit:3 },
  { id:'calcalist',name:'כלכליסט',       color:'#e11d48', icon:'💼', url:'https://www.calcalist.co.il/GeneralRSS/0,16335,L-5,00.xml',                                      limit:3 },
  ...
  { id:'globes',   name:'גלובס',         color:'#15803d', icon:'💹', url:'https://www.globes.co.il/rss/rss.asp?cnt=902',                                               limit:3 },
];
