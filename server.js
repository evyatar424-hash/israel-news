...
const CHANNELS = [
  ...
  { id:'calcalist',name:'כלכליסט',      color:'#e11d48', icon:'💼', url:'https://www.calcalist.co.il/GeneralRSS/0,16335,L-8,00.xml',                 limit:3 },
  { id:'themarker',name:'TheMarker',     color:'#15803d', icon:'📈', url:'https://www.themarker.com/srv/tm-rss',                                     limit:3 },
